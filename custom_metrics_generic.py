...
def get_metrics(subscription_id):
    ...
    dir_user = '/userfs' if 'jupyter-lab' in env_name else '/home/wmlfuser'
    print(dir_user)

    path_script = 'DeepLIIF_Statistics/ComputeStatistics.py'

    dir_gt = metadata['openscale_custom_metric_provider']['generic_metrics']['dir_gt']#'DeepLIIF_Datasets/model_eval/gt_images'
    dir_pred = metadata['openscale_custom_metric_provider']['generic_metrics']['dir_pred']#'DeepLIIF_Datasets/model_eval/model_images'
    most_recent = metadata['openscale_custom_metric_provider']['generic_metrics']['most_recent']#5
